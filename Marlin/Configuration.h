...
#define STRING_CONFIG_H_AUTHOR "(Mitja Nevecny, Prusa Bear SKR 1.4)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bear SKR"
 ...
 *    80 : 100k, beta25 = 3950 K, 4.7 kOhm pull-up, KINGROON
...
#define HEATER_0_MAXTEMP 270+15
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  /*SKR - PID*/
  //#define  DEFAULT_bedKp 126.13 //MK42 Prusa default
  //#define  DEFAULT_bedKi 4.30   //MK42 Prusa default
  //#define  DEFAULT_bedKd 924.76 //MK42 Prusa default
  #define DEFAULT_bedKp 47.38
  #define DEFAULT_bedKi 2.32
  #define DEFAULT_bedKd 644.36
...
#define Z_MIN_ENDSTOP_INVERTING false //PINDA v1// Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false //PINDA v1 // Set to true to invert the logic of the probe.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 25, 60 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1250, 1250, 400, 3000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 5000, 5000, 200, 9000 } // ...or, set your own edit limits
#endif
 ...
 *
 */
#define Z_MIN_PROBE_PIN P0_10 //PROBE pin 0.10 on SKR 1.4//32 // Pin 32 is the RAMPS default
...
#define Z_CLEARANCE_MULTI_PROBE     1 //0.6 // Z Clearance between multiple probes
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 36 //X_CENTER  // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 7 //Y_CENTER  // Y point for Z homing when homing all axes (G28).
#endif
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 //Prusa:20
#define LCD_FEEDBACK_FREQUENCY_HZ 5000 //Prusa:1000
